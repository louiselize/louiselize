...
⚡ **Currently:** I'm a **Software Data Engineer** at [Odite Sagemcom](https://odit-e.com/en/). My role involves enabling search algorithms to be effectively used by clients, specifically Distribution System Operators (DSOs). I primarily work on backend development, focusing on building APIs and managing data workflows before and after the application of the search algorithms. This is all within the context of improving the distribution and understanding of low-voltage electrical networks.
